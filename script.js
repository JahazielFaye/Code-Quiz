...
function showQuestions(index) {
 ...
 let questions = [
    {
        numb: 1,
        question: "Booleans have only 2 value options",
    ...
    },
    {
        ...
        options: [
            ...
            "American Programming Institute",
            "Address Protocol Interner",
    ...
    {
        number: 3,
        question: "Whichof the following keywords is used to define a variable in JavaScript?",
        answer: "Both A & B",
        options: [
            "var",
            "let",
